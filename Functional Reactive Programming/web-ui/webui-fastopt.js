...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  var delta$2 = $uD(this.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a, b, c).apply__O());
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$1, delta$1) {
    return (function() {
      if ((delta$1 > 0)) {
        var array = [((((-$uD(b$1.apply__O())) + $uD($g.Math.sqrt(delta$1))) / 2) * $uD(a$2.apply__O())), ((((-$uD(b$1.apply__O())) - $uD($g.Math.sqrt(delta$1))) / 2) * $uD(a$2.apply__O()))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  var B = $uD(b.apply__O());
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, c$1, B$1) {
    return (function() {
      return ((B$1 * B$1) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, c, B));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
